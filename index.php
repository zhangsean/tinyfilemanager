...
$landingExampleURL = "https://www.startpage.com";
...
#site {
  ...
  width: 50%;
		...
		<?php
      die("<html><head><title>IIS</title></head><body><div id='space'> <div class='stars'></div> <div class='stars'></div> <div class='stars'></div> <div class='stars'></div> <div class='stars'></div> </div><center><h1>PROXY</h1><br /><form onsubmit=\"if (document.getElementById('site').value) { window.location.href='" . PROXY_PREFIX . "' + document.getElementById('site').value; return false; } else { window.location.href='" . PROXY_PREFIX . $landingExampleURL . "'; return false; }\" autocomplete=\"off\"><input id=\"site\" type=\"text\" size=\"50\" /></form></body></html>");
    } else {
      $url = $startURL;
    }
